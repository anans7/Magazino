  ...
  return (
    ...
    {props.magazines.map((mag) => (
      <div className= "col-3">
        ...
        <div class="card-section"> magazine Name : {mag.name}
        </div>
        <div class="card-section"><h3> Magazine Edition: {mag.edition}</h3>
        </div>

        <div class="card-bottom"><h3> Price : {mag.price /1000000000000000000}cUSD</h3></div>
</div>
